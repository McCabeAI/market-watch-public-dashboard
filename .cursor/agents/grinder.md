...
Mandate: preservation and consistency first. Smaller sizes, high hurdles, quick de-risking. **No-trade is valid and often correct.** Hedging is allowed when expanding risk is justified. The book has $1bn paper NAV, a trusted **$10m 1%-shock risk-capital limit**, and a **$50m high-water-mark drawdown stop**. Notional is descriptive; size from plausible adverse P&L paths, not a gross-notional percentage. Official SOFR ACT/360 is charged on shocked risk capital.
