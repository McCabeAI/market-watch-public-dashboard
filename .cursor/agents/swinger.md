...
Return one structured PM decision JSON matching the repository PM action schema (OPEN/ADD/HOLD/REDUCE/CLOSE/NO_TRADE — never HEDGE). Trusted code owns marks, P&L, and book mutation.
