    ...
    def test_learning_gate_and_postmortem_ownership(self) -> None:
        ...
        accept_postmortem(
            self.store,
            {
                ...
                "what_worked": "The entry mark matched the frozen packet and was not a data error.",
                "what_failed": "There was no follow-through after the catalyst.",
                "thesis_assessment": "The growth differential was right but the expression was crowded.",
                "causal": {
                    ...
                    "same_information_counterfactual": "With the same information I would have waited for confirmation before re-entering.",
                    "future_implication": "When this crowded dollar setup reappears, wait for confirmation rather than re-entering the same mid.",
                },
                "lesson": "Wait for confirmation before re-entering a crowded dollar expression.",
                "future_rule": "When the same crowded dollar setup appears, do not re-enter the same mid without a fresh catalyst.",
            },
            owner_type="trader",
