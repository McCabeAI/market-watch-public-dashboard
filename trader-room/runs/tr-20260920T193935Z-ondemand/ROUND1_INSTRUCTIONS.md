...
- `trader-room/runs/tr-20260920T193935Z-ondemand/PACKET_FACTS.json`
- `trader-room/runs/tr-20260920T193935Z-ondemand/advocate_card.json`
- `trader-room/runs/tr-20260920T193935Z-ondemand/evidence_packet.json` for any field you need
- your own sidecar `trader-room/runs/tr-20260920T193935Z-ondemand/memory/<seat>.json`
...
- `vol-convexity`: options only (debate trade). Paper may HOLD if unmarkable.
- every other trading seat is rates-first: write a concrete rates candidate and a concrete spot candidate; prefer rates when comparable; choose spot only with an explicit reason rates is inferior/unavailable.
- `no-trade-skeptic` may return `trade: null` plus required `funding_view`.

## Output

Write **one** JSON object to:

`trader-room/runs/tr-20260920T193935Z-ondemand/submissions/<seat>.json`
