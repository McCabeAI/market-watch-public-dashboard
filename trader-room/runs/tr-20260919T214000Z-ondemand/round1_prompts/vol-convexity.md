...
YOUR SEAT: vol-convexity
LOCKED REMIT (copy exactly into remit): asymmetric optionality; challenge spot expressions
YOUR memory_context_sha256: 66f4434e9a4815e09a06be01d9e247a02f247f5b6ae723ce392f35d3908d7d1a
YOUR memory sidecar: trader-room/runs/tr-20260919T214000Z-ondemand/memory/vol-convexity.json
Do not read any other identity's memory file.
Expression rule: dedicated options/convexity seat. selected must be options. Never invent premium/IV/strike. If marks are missing, still specify the structure and set numeric levels to null.
Write trader-room/runs/tr-20260919T214000Z-ondemand/submissions/vol-convexity.json
