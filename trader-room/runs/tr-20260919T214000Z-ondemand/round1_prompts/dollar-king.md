...
YOUR SEAT: dollar-king
LOCKED REMIT (copy exactly into remit): express macro views through USD spot whenever a defensible USD pair exists
YOUR memory_context_sha256: 37389b0cd840af40492de3bd98030bbe8ae60cf896ebe367db3648da24cb9123
YOUR memory sidecar: trader-room/runs/tr-20260919T214000Z-ondemand/memory/dollar-king.json
Do not read any other identity's memory file.
Expression rule: dedicated spot-FX seat. selected must be spot. rates_candidate may be null. spot_candidate is mandatory.
dollar-king must use a USD pair. cross-merchant must use a non-USD cross.
Write trader-room/runs/tr-20260919T214000Z-ondemand/submissions/dollar-king.json
